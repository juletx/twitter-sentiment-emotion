...
\begin{figure*}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_negative_manual.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_negative_auto.png}}
    \caption{Wordclouds for manual and automatic negative tweets.}
    \label{fig:wordclouds_negative}
\end{figure*}

\begin{figure*}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_neutral_manual.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_neutral_auto.png}}
    \caption{Wordclouds for manual and automatic neutral tweets.}
    \label{fig:wordclouds_neutral}
\end{figure*}

\begin{figure*}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_positive_manual.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_positive_auto.png}}
    \caption{Wordclouds for manual and automatic positive tweets.}
    \label{fig:wordclouds_positive}
\end{figure*}

\begin{figure*}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_anger_manual.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_anger_auto.png}}
    \caption{Wordclouds for manual and automatic anger tweets.}
    \label{fig:wordclouds_anger}
\end{figure*}

\begin{figure*}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_joy_manual.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_joy_auto.png}}
    \caption{Wordclouds for manual and automatic joy tweets.}
    \label{fig:wordclouds_joy}
\end{figure*}

\begin{figure*}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_optimism_manual.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_optimism_auto.png}}
    \caption{Wordclouds for manual and automatic optimism tweets.}
    \label{fig:wordclouds_optimism}
\end{figure*}

\begin{figure*}[ht]
    \centering
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_sadness_manual.png}}
    \subfloat{\includegraphics[width=0.49\linewidth]{wordcloud_sadness_auto.png}}
    \caption{Wordclouds for manual and automatic sadness tweets.}
    \label{fig:wordclouds_sadness}
\end{figure*}
